...
export function GitHubSVG(props: CSSProps) {
	return <>
...
export function FigmaSVG(props: CSSProps) {
	return <>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 57" aria-hidden="true" {...props}>
...
export function TwitterSVG(props: CSSProps) {
	return <>
...
export function ReactSVG(props: CSSProps) {
	return <>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="-11.5 -10.23174 23 20.46348" aria-hidden="true" {...props}>
